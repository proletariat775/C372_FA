-- Add loyalty points support (balance cache, redemption fields, ledger table).

ALTER TABLE users
  ADD COLUMN IF NOT EXISTS loyalty_points_balance INT NOT NULL DEFAULT 0 AFTER free_delivery;
